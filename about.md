...
I am also an applied quantitative methodologist. My substantive research frequently requires developing new measures and empirical strategies for political behavior that existing data cannot adequately capture. I use causal inference, machine learning, AI-based classification, text-as-data, statistical measurement, and large-scale data collection to make these phenomena observable, often developing datasets and research tools that can be reused by other scholars.
